...
CREATE TABLE doctors (
  ...
  first_name VARCHAR2(20) NOT NULL,
  last_name VARCHAR2(20) NOT NULL,
  gender CHAR(1) NOT NULL, -- tutaj mozna dac trigger do tworzenia i edycji upewniajacy sie ze ta wartosc to M dla faceta, F dla kobiety lub O dla innego
  date_of_birth DATE NOT NULL,
...
CREATE TABLE drugs (
  ...
  drug_description VARCHAR2(500), -- nie moglo byc description bo to jakis keyword w plsql
  dosage_method VARCHAR2(20),
  serial_number VARCHAR2(6),
  CONSTRAINT pk_drugs
    PRIMARY KEY (drug_id)
);
